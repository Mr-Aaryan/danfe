export const Icons = {
  ...
  facebook: {
    ...
    class: "size-8 flex-shrink-0 fill-current",
    viewBox: "0 0 24 24",
    stroke: "currentColor",
  },
  x: {
  ...
  whatsapp: {
    paths: [
      {
        d: "M12,0C5.373,0,0,5.373,0,12s5.373,12,12,12s12-5.373,12-12S18.627,0,12,0z M9.862,17.601l0.748-0.387 c0.208,0.113,1.251,0.645,2.846-1.539c1.594-2.184,2.032-3.78,2.147-3.988l-0.718-0.502c-0.208-0.113-1.061-0.502-2.147-0.933 c-1.087-0.433-1.833-0.979-2.24-1.64c-0.408-0.662-0.482-1.463-0.131-2.381c0.352-0.918,1.087-1.559,2.24-1.922 c1.152-0.387,2.433-0.244,3.749,0.467c1.308,0.7,2.206,1.722,2.732,3.064c0.52,1.341,0.572,2.731,0.131,4.173 c-0.433,1.452-1.217,2.497-2.355,3.138c-1.139,0.645-2.431,0.833-3.88,0.467C10.939,18.155,10.231,17.98,9.862,17.601z M17.812,14.512c0.125-0.167,0.241-0.36,0.346-0.583c0.104-0.225,0.156-0.448,0.156-0.673c0-0.192-0.052-0.366-0.156-0.52 c-0.104-0.156-0.216-0.283-0.346-0.379c-0.133-0.094-0.258-0.147-0.375-0.156c-0.117-0.01-0.224-0.016-0.323-0.016 c-0.272,0-0.52,0.073-0.74,0.221c-0.219,0.146-0.4,0.354-0.542,0.625c-0.146,0.271-0.219,0.563-0.219,0.876 c0,0.313,0.073,0.605,0.219,0.876c0.142,0.271,0.322,0.479,0.542,0.625c0.22,0.146,0.468,0.219,0.74,0.219 c0.094,0,0.199-0.005,0.313-0.016c0.112-0.01,0.233-0.062,0.365-0.156c0.134-0.096,0.251-0.224,0.354-0.385 C17.562,14.868,17.687,14.68,17.812,14.512z",
      },
    ],
    class: "size-8 flex-shrink-0 fill-current",
    viewBox: "0 0 24 24",
